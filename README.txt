...
All the questions are written to an output.txt file at the top level of the project and sorted by Question type after they have all been answered
...
To Run Test Program
--------------------
// unit test program for QuestionService
npm test
